...
AUTOPILOT_ROOT := /home/dvd/Vitis_HLS/2023.1
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /home/dvd/Vitis_HLS/2023.1/tps/lnx64/gcc-8.3.0/bin
endif
...
$(ObjDir)/dab_tb.cpp_pre.cpp.tb.o : dab_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling dab_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/dab.cpp_pre.cpp.tb.o : dab.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling dab.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
