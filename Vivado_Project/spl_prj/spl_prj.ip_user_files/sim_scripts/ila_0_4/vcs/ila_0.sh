...
#
# Script generated by Vivado on Tue Mar 19 20:52:46 GMT 2024
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../spl_prj.gen/sources_1/ip/ila_0_4/hdl/verilog" +incdir+"/home/dvd/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../spl_prj.gen/sources_1/ip/ila_0_4/hdl/verilog" +incdir+"/home/dvd/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../spl_prj.gen/sources_1/ip/ila_0_4/hdl/verilog" +incdir+"/home/dvd/Vivado/2023.1/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dvd/SPL/spl_prj/spl_prj.cache/compile_simlib/vcs"
  fi
