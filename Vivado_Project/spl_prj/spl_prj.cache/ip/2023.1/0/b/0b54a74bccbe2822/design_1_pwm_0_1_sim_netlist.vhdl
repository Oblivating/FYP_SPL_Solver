...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm is
  port (
    ...
    duty_18_sp_1 : out STD_LOGIC;
    duty_26_sp_1 : out STD_LOGIC;
    duty_2_sp_1 : out STD_LOGIC;
    duty_10_sp_1 : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm is
  ...
  signal duty_10_sn_1 : STD_LOGIC;
  signal duty_18_sn_1 : STD_LOGIC;
  signal duty_26_sn_1 : STD_LOGIC;
  signal duty_2_sn_1 : STD_LOGIC;
  signal p_0_in : STD_LOGIC;
  signal pwm1_reg : STD_LOGIC;
  ...
  signal pwm_out1_INST_0_i_5_n_0 : STD_LOGIC;
  signal pwm_out1_INST_0_i_6_n_0 : STD_LOGIC;
  signal pwm_out1_INST_0_i_7_n_0 : STD_LOGIC;
  signal pwm_out1_INST_0_i_8_n_0 : STD_LOGIC;
...
begin
  duty_10_sp_1 <= duty_10_sn_1;
  duty_18_sp_1 <= duty_18_sn_1;
  duty_26_sp_1 <= duty_26_sn_1;
  duty_2_sp_1 <= duty_2_sn_1;
...
pwm_out1_INST_0: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFE0000"
    )
        port map (
...
pwm_out1_INST_0_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
pwm_out1_INST_0_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
pwm_out1_INST_0_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
pwm_out1_INST_0_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
pwm_out1_INST_0_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
pwm_out1_INST_0_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
pwm_out1_INST_0_i_7: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
pwm_out1_INST_0_i_8: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
pwm_out2_INST_0: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFE0000"
    )
        port map (
...
solver_en_INST_0: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
